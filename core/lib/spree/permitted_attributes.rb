module Spree
  module PermittedAttributes
    ...
    @@user_attributes = [:email, :password, :password_confirmation, :doctor_name, :clinic_name, :patient_id, :clinic_phone, :photo, :driver_license_number, :driver_license_expiration]
